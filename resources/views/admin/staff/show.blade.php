                ...
                <div class="col-md-4">
                    <div class="card p-3 d-flex align-items-center justify-content-center"
                        ...
                        <a href="{{ route('admin.staff.edit', $staff->id) }}"
                            class="btn btn-sm btn-primary position-absolute" style="top: 10px; right: 10px;">
                                ...
                                <div class="tab-pane fade" id="work" role="tabpanel" aria-labelledby="work-tab">
                                    ...
                                    <div id="intern-details"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="supervisor_id" id="supervisor_id" class="form-control"
                                                value="{{ old('supervisor_id', $staff->internDetails->supervisor_id ?? '') }}" readonly>
                                        </div>
                                        <div class="mb-3">
